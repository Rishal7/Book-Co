...
export const Faq = () => {
  ...
  return (
    <section className="my-10 p-7 border rounded-lg dark:border-slate-700 dark:bg-gray-800 shadow-sm">
      <h1 className="text-2xl text-center font-semibold dark:text-slate-200 mb-3 underline underline-offset-8">
        Question in mind?
      </h1>
      <div
        className=""
