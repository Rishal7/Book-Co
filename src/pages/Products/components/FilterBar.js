  ...
  return (
    <section className="filter">
      <div
        ...
        className={`fixed z-40 h-screen p-6 overflow-y-auto  w-72 border-r border-slate-200 bg-white dark:bg-gray-800 transition-transhtmlForm left-0 top-0 transhtmlForm-none`}
        tabIndex="-1"
          ...
          <ul className="text-slate-700 dark:text-slate-100">
            ...
            <li className="mt-1 mb-5 px-1">
              <button
                ...
                type="button"
                className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-1 focus:ring-gray-200 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
              >
                Clear Filter
              </button>
            </li>
